...
public class JiraExporterTest {
  ...
  @Test
  public void testCreateOrUpdateItem_forceCreate(@Mocked ODocument workItem, @Mocked StorageEngine store,
    ...
    new Expectations(jiraExporter) {
      {
        ...
        invoke(jiraExporter, "forceUpdate");
        result = true;
      }
    };
  ...
  @Test
  public void testCreateOrUpdateItem_itemIdEmpty(@Mocked ODocument workItem, @Mocked StorageEngine store,
      @Mocked StorageQuery storageQuery, @Mocked Optional<Project> projectOptional) throws Exception {
  ...
  public void testCreateItem() throws Exception {
    ...
    jiraExporter.createIssueFromWorkItem(workItem, project);
  ...
  @Test
  public void testCreateOrUpdateItem_notForceCreate(@Mocked ODocument workItem, @Mocked StorageEngine store,
